...
const reviews = [
  ...
  { id: "04", name: "Emma Wilson", role: "Creative Lead", text: "They don't just build websites, they build digital experiences that convert and engage users.", img: img.company5 },
...
export default function UserReviews() {
  return (
    <section className="bg-[#fafafa] w-full h-screen flex flex-col py-16 md:py-24 overflow-hidden select-none">
      ...
      <style jsx global>{`
        /* 4. Use linear easing for a seamless continuous flow */
        .swiper-wrapper {
          transition-timing-function: linear !important;
        }
        .swiper-free-mode > .swiper-wrapper {
           /* Overriding your original cubic-bezier for the autoplay effect */
          transition-timing-function: linear !important;
        }
      `}</style>
    </section>
